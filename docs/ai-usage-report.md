...
* **ChatGPT** – Used mainly for understanding JavaScript concepts and logic. It helped clarify how features such as search filtering, event handling, and validation work. This ensured that I fully understood the implementation before applying it.
